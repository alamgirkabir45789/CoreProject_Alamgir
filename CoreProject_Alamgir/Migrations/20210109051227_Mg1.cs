    ...
    public partial class Mg1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PatientID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    PatientName = table.Column<string>(maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InternDoctorID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DepartmentID = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InternDoctors_Departments_DepartmentID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicineItem_MedicineCategory_MedicineCategoryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternDoctors_DepartmentID",
                table: "InternDoctors",
                column: "DepartmentID");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineItem_MedicineCategoryID",
                table: "MedicineItem",
